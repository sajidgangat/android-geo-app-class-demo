...
public interface Constants {
    ...
    String PREF_KEY_CHAT_SESSION_TIMER ="key_chat_session_timer";
    ...
    String BROADCAST_USER_TIME_EXCEED= BASE + "USER_TIME_EXCEED";

    String CHAT_USER_COUNT = "CHAT_USER_COUNT";
    String CHAT_USER_NAME = "CHAT_USER_NAME";
    String CHAT_MESSAGE = "CHAT_MESSAGE";
    String CURRENT_CHAT_SESSION_TIMER = "CURRENT_CHAT_SESSION_TIMER";
